...
class CartService {
  ...
  // ValueNotifier to broadcast the item count for the badge
  ...
  void updateQuantity(int index, int newQty) {
    if (newQty > 0) {
      ...
      remove(index); // Remove if qty is 0 or less
    }
    // No count update needed, as an item isn't added or removed
  }
