        ...
        children: [
          ...
          Card(
            child: ListTile(
              ...
              title: const Text('Stock Adjustments Log'),
              trailing: const Icon(Icons.chevron_right),
              onTap: () {
                 Navigator.push(
                  context,
          ...
          Card(
            child: ListTile(
              leading: Icon(Icons.summarize, color: Theme.of(context).colorScheme.primary),
              title: const Text('Inventory Report Summary'),
              trailing: const Icon(Icons.chevron_right),
              onTap: () {
                 Navigator.push(
                  context,
          ...
          Card(
            child: ListTile(
              leading: Icon(Icons.receipt_long, color: Colors.purple[700]),
