// lib/pages/shared/product_search_page.dart
...
enum ProductSearchMode {
  simpleSelect, // Just pops the selected product
  restockEntry, // Pops a dialog to get qty/price, then pops the item data
}
...
class _ProductSearchPageState extends State<ProductSearchPage> {
  ...
  // Handle the tap based on the mode
  void _onProductTap(Map<String, dynamic> product) {
    if (widget.mode == ProductSearchMode.simpleSelect) {
      // Just pop the selected product
      Navigator.of(context).pop(product);
    } else {
      // Show the restock entry dialog
