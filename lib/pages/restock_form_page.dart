...
import 'product_search_restock_page.dart';
...
class _RestockFormPageState extends State<RestockFormPage> {
  ...
  void _addItem() async {
    // Navigate to the product search page and wait for a result
    final result = await Navigator.push(
      context,
      MaterialPageRoute(builder: (_) => const ProductSearchRestockPage()),
    );
