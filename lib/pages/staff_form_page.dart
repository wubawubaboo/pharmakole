// lib/pages/staff_form_page.dart
...
class _StaffFormPageState extends State<StaffFormPage> {
  ...
  String _role = 'staff'; // Default role
  ...
  void initState() {
    ...
    _password = TextEditingController(); // Always empty for security
    _role = u?['role'] ?? 'staff';
  }
  ...
  Future<void> _saveUser() async {
    ...
    // Remove null password if it's empty (for update)
