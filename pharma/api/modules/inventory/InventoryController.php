<?php
// --- FIX #1: Added the missing require for the jsonResponse function ---
require_once __DIR__.'/../../helpers.php';
// --- FIX #2: Added the missing require for the authenticate function ---
...
public function handle($method, $get, $post, $body){
    // This function will now be available and work correctly.
    authenticate(); 
    ...
    if($method === 'GET' && strpos($path, '/api/inventory/list') !== false){
        ...
        // This function will now be available and will work correctly.
        jsonResponse(['data'=>$r]);
        return;
    }
